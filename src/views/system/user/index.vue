    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="管理员编号" align="center" key="userId" prop="userId" v-if="columns[0].visible" />
          <el-table-column label="管理员名称" align="center" key="userName" prop="userName" v-if="columns[1].visible" :show-overflow-tooltip="true" />
          <el-table-column label="管理员昵称" align="center" key="nickName" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" />
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="管理员名称" prop="nickName">
              <el-input v-model="form.nickName" placeholder="请输入管理员名称" maxlength="30" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="管理员密码" prop="password">
              <el-input v-model="form.password" placeholder="请输入管理员密码" type="password" maxlength="20" show-password/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 1, label: `管理员名称`, visible: true },
        { key: 2, label: `管理员昵称`, visible: true },
      ...
      rules: {
        userName: [
          ...
          { min: 2, max: 20, message: '管理员名称长度必须介于 2 和 20 之间', trigger: 'blur' }
        ],
        nickName: [
        ...
        password: [
          ...
          { min: 5, max: 20, message: '管理员密码长度必须介于 5 和 20 之间', trigger: 'blur' }
        ],
        email: [
          {
            type: "email",
  ...
  methods: {
    ...
    handleResetPwd(row) {
      this.$prompt('请输入"' + row.userName + '"的新密码', "提示", {
        ...
        inputPattern: /^.{5,20}$/,
        inputErrorMessage: "管理员密码长度必须介于 5 和 20 之间"
      }).then(({ value }) => {

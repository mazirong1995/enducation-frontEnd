    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="学生名称" align="center" key="nickName" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" />
...
<script>
import { listUser, listStudent, getUser, delUser, addUser,addUserStudent, updateUser, resetUserPwd, changeUserStatus, deptTreeSelect } from "@/api/system/user";
...
export default {
    ...
    return {
      ...
      rules: {
        userName: [
          ...
          { min: 2, max: 20, message: '学生名称长度必须介于 2 和 20 之间', trigger: 'blur' }
        ],
        nickName: [
        ...
        password: [
          ...
          { min: 5, max: 20, message: '学生密码长度必须介于 5 和 20 之间', trigger: 'blur' }
        ],
        email: [
          {
            type: "email",
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.userName + '"学生吗？').then(function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除所选学生的数据项？').then(function() {
